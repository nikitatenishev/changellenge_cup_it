...
def create_embeddings(
    ...
    np.save(f"{output_filename}", embeds)
...
def calulacte_cos_measure(
    ...
    np.save(f"{output_filename}", cos_measure)
...
def calculate_euclidean_measure(
    ...
    np.save(f"{output_filename}", euclidean_measure)
...
def calculate_manhattan_measure(
    ...
    np.save(f"{output_filename}", manhattan_measure)
...
def create_toxic(
    ...
    np.save(f"{output_filename}", toxic)
